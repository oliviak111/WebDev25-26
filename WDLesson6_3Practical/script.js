...
let seafoods = [
  {title: "Clams", image: "clams.jpg", price: 10.99},
  {title: "Crabs", image: "crabs.jpg", price: 15.99},
  {title: "Lobster", image: "lobster.png", price: 25.99},
  {title: "Scallop", image: "scallops.jpg", price: 12.99},
  {title: "Shrimp", image: "shrimp.jpg", price: 11.99},
  {title: "Tuna", image: "tuna.jpg", price: 19.99},
];

// Challenge 6: Create an array of JSON where each JSON contains the name, an image source and price for each Dessert item.  
let desserts = [
  {title: "Flan", image: "flan.jpg", price: 5.99},
  {title: "Passionberry", image: "passionberry.jpeg", price: 9.99},
  {title: "Oreo Cup", image: "oreocup.jpg", price: 7.99},
];
...
function showSeafood(){
 ...
 for(let i = 0; i < seafoods.length; i++){
  let seafood = seafoods[i];
  build += `<div class = "card" id = "title">
              <h3>${seafood.title}</h3>
              <img src = "images/${seafood.image}">
              <p> $${seafood.price} </p>
            </div>`;
