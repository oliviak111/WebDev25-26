...
3) Create an appropriate random price to display for each pizza(say 15~35). No HTML element needed
...
function init(){
   ...
   for(let i=1; i<=5; i++){
      let price = Math.floor(Math.random()*(35 - 15 +  1));
      build += `<div class="card">
                     <img src="images/title${i}.png" class = "title"></img>
                     <img src="images/pizza${i}.jpg" class = "pizza"></img>
                     <br></br> $ ${price}
